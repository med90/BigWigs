...
L.coreAddonDisabled = "BigWigs non può funzionare correttamente perché l'addon %s è disattivato. Puoi attivarlo nel pannello di controllo degli Addon nella schermata di login dei personaggi."
...
L.finishedLoading = "Combattimento terminato, BigWigs è stato caricato completamente."
L.FLASH = "Lampeggio"
